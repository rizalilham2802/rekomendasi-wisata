...
$(document).ready(function () {
  $('#recomend').attr('href', 'recomendasiwisata.html');
});
$(document).ready(function () {
  $('#skill').attr('href', 'galeri.html');
});
$(document).ready(function () {
  $('#blog').attr('href', 'blog.html');
});

$(function () {
  $('.navbar').css({ 'background-color': 'rgba(0, 0, 255, 0.274)' });
});

// $(function () {
//   $('.nav-link').css({ 'font-size': '15px', color: 'black' });
// });
$(function () {
  $('card-text').css({ 'font-size': '15px', color: 'black', 'text-align': 'center' });
});
$(function () {
  $('.judul').css({ 'font-size': '15px', color: 'black', 'text-align': 'center' });
});
...
function scrollFunction() {
  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
    ...
    document.getElementById('logo-a').style.boxShadow =
      'orangered 0px 20px 0px -10px, orangered 0px -20px 0px -10px, orangered 20px 0px 0px -10px, orangered -20px 0px 0px -10px, 10px -10px orangered, -10px 10px orangered, black 0px 0px 0px 3px, rgb(0 0 0 / 0%) 5px 5px 15px 5px';
  } else {
